              ...
              <form className="space-y-4">
                ...
                <div className="flex items-start gap-2 text-sm">
                  ...
                  <p className="text-primary">
                    I agree to the processing of my personal data in accordance with <br />
                    the{" "}
                    <Link href="/privacy-policy" className="text-secondary">
                      Privacy Policy
                    </Link>{" "}
                    and consent to receive communications about this <br />
                    inquiry .*
                  </p>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#F7EDFE] rounded-2xl border-[#E5E7EB] p-8 space-y-4">
                ...
                <div className="flex flex-row gap-4 justify-start p-4">
                  <div className="bg-[#EAD5F9] border-[#E5E7EB] rounded-2xl p-4 text-secondary text-3xl transition-transform duration-500 ease-in-out hover:rotate-180">
                    <a href="https://www.facebook.com/Devisgon/">
                      <FaSquareFacebook />
                    </a>
                  </div>
                  <div className="bg-[#EAD5F9] border-[#E5E7EB] rounded-2xl p-4 text-secondary text-3xl transition-transform duration-500 ease-in-out hover:rotate-180">
                    <a href="https://www.linkedin.com/company/devisgon/posts/?feedView=all">
                      <IoLogoLinkedin />
                    </a>
                  </div>
                  <div className="bg-[#EAD5F9] border-[#E5E7EB] rounded-2xl p-4 text-secondary text-3xl transition-transform duration-500 ease-in-out hover:rotate-180">
                    <a href="https://www.instagram.com/devisgon?igsh=MXczMDQwcnJkc3djMA==">
                      <FaInstagram />
                    </a>
                  </div>
                </div>
