...
<body style="margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #f9f9fb;">
  ...
  <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.05); border: 1px solid #e1e1e8;">
    ...
    <div style="background: linear-gradient(135deg, #8145B5 0%, #402060 100%); padding: 40px 20px; text-align: center;">
      ...
      <p style="margin: 8px 0 0; color: rgba(255,255,255,0.8); font-size: 14px; font-weight: 400;">New Job Apply</p>
    </div>

    <div style="padding: 40px 35px;">
      <h2 style="color: #1a1a1a; font-size: 20px; margin-top: 0; margin-bottom: 20px; font-weight: 700;">You've got a new applicant!</h2>
      <p style="color: #666666; font-size: 15px; line-height: 1.6; margin-bottom: 30px;">
        A candidate has submitted an application through the DEVISGON Get Started form.
      </p>

      <div style="background-color: #fcfaff; border-radius: 12px; padding: 20px; border: 1px solid #f0e6f7;">
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="padding: 10px 0; font-size: 13px; color: #8145B5; font-weight: 700; text-transform: uppercase;">Applicant Name</td>
          ...
          <tr>
            <td style="padding: 10px 0; font-size: 13px; color: #8145B5; font-weight: 700; text-transform: uppercase; border-top: 1px solid #ede7f3;">Application Type</td>
            <td style="padding: 10px 0; font-size: 15px; color: #1a1a1a; text-align: right; border-top: 1px solid #ede7f3;">${applicationType}</td>
          </tr>
          <tr>
            <td style="padding: 10px 0; font-size: 13px; color: #8145B5; font-weight: 700; text-transform: uppercase; border-top: 1px solid #ede7f3;">Selected Program</td>
            <td style="padding: 10px 0; font-size: 15px; color: #1a1a1a; text-align: right; border-top: 1px solid #ede7f3;">${program}</td>
          </tr>
          <tr>
            <td style="padding: 10px 0; font-size: 13px; color: #8145B5; font-weight: 700; text-transform: uppercase; border-top: 1px solid #ede7f3;">Education</td>
            <td style="padding: 10px 0; font-size: 15px; color: #1a1a1a; text-align: right; border-top: 1px solid #ede7f3;">${education}</td>
          </tr>
          <tr>
            <td style="padding: 10px 0; font-size: 13px; color: #8145B5; font-weight: 700; text-transform: uppercase; border-top: 1px solid #ede7f3;">Experience</td>
            <td style="padding: 10px 0; font-size: 15px; color: #1a1a1a; text-align: right; border-top: 1px solid #ede7f3;">${experience || 'None'}</td>
          </tr>
          <tr>
            <td style="padding: 10px 0; font-size: 13px; color: #8145B5; font-weight: 700; text-transform: uppercase; border-top: 1px solid #ede7f3;">Portfolio / LinkedIn</td>
            <td style="padding: 10px 0; font-size: 15px; color: #1a1a1a; text-align: right; border-top: 1px solid #ede7f3;">
              ${portfolioLink ? `<a href="${portfolioLink.startsWith('http') ? portfolioLink : 'https://' + portfolioLink}" style="color: #8145B5; text-decoration: none; font-weight: 600;" target="_blank">${portfolioLink}</a>` : 'Not provided'}
            </td>
          </tr>
