      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
        ...
        <div className="mb-6">
          <motion.span
            ...
            className="inline-block h-8 py-2 px-6 rounded-full bg-gradient-to-br from-[#FBF7FE] to-[#d4adf6] text-t-primary text-sm font-medium tracking-wide border border-[#e9e3f8]"
          >
            {data.pre_title}
          </motion.span>
        </div>
