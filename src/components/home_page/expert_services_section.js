...
const ExpertServicesSection = () => {
  const section = data.expert_services_section;
        ...
        <div className="relative w-full">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 bg-white rounded-2xl shadow-2xl p-4 sm:p-6 w-64 sm:w-72 z-20">
            <ul className="space-y-3 sm:space-y-4">
              {section.process_checklist_card.items.map((item, index) => (
          ...
          <div
            ...
            "
          >
            {section.core_info_cards.map((card, index) => (
              <div
                key={index}
              ...
              >
                ...
                <p
                  className="text-[10px] sm:text-xs leading-relaxed sm:leading-relaxed opacity-90"
