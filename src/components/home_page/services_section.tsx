...
const cards = [...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,...data.services_list,]
  return (
        ...
        <div className={styles.cardsWrapper}>
          <div className={styles.track}>
            {cards.map((card, index) => (
              <div
                key={index}
                className={`${styles.card} group relative flex-shrink-0 overflow-hidden rounded-lg shadow-lg`}
              >
