  ...
  return (
    <section className="relative w-full bg-bg-secondary min-h-[90vh] flex flex-col items-center justify-center overflow-hidden pt-20 pb-32">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
        ...
        <div className=" absolute top-24 left-16 w-18 h-0.5 rotate-45 opacity-90 bg-[linear-gradient(to_right,#FFFFFF00,#8E4EC6)]" />
        <div className=" absolute top-52 right-4 w-18 h-0.5 -rotate-45 opacity-90 bg-[linear-gradient(to_right,#8E4EC6,#FFFFFF00)]" />
        <div className="  absolute top-64 left-2 w-16 h-0.5 rotate-45 opacity-30 bg-[linear-gradient(to_right,#FFFFFF00,#8E4EC6)]" />
        <div className=" absolute top-82 right-1 w-16 h-0.5 -rotate-45 opacity-30 bg-[linear-gradient(to_right,#8E4EC6,#FFFFFF00)]" />
        ...
        <p className="text-t_secondary text-lg md:text-xl font-medium max-w-2xl mb-12">
          {data.description}
        </p>
