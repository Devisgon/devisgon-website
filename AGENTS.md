...
- Site-wide in-body internal linking uses `src/components/shared/internal_links.tsx`, with contextual link sets rendered across home, services, service detail, industries, industry detail, technologies, technology detail, partners, blogs, process, contact, get-started, legal, and 404 pages so users and crawlers can move between major content areas without relying only on the navbar/footer.
